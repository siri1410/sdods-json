      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="max-w-lg mx-auto bg-white dark:bg-gray-800 shadow-lg rounded-lg overflow-hidden">
          <div className="px-6 py-8">
            <h1 className="text-3xl font-bold mb-6 text-center text-gray-800 dark:text-white">Contact Us</h1>
            {error && <p className="text-red-500 mb-4 text-center">{error}</p>}
            {!user ? (
              <p className="text-center text-gray-600 dark:text-gray-300 mb-4">Please sign in to send a message.</p>
            ) : (
